# Reviewers' Guide — APF Paper 13: The Minimal Admissibility Core

This guide is the physics-first walkthrough for peer reviewers of The Minimal Admissibility Core. It addresses the structural assumptions, anticipated objections, and falsification surfaces of the paper's argument. The intended audience is a peer reviewer with a background in physics or mathematics.
...
- The [interactive derivation DAG](https://ethan-brooke.github.io/The-Minimal-Admissibility-Core/) (hover-for-details, click-for-dependencies, animated verification).
...
To prevent scope inflation, the following are flagged explicitly as *outside* the scope of Minimal Admissibility Core:
...
This repository is the executable mathematical appendix to APF Paper 13. The canonical archival deposit is at [https://doi.org/10.5281/zenodo.18614663](https://doi.org/10.5281/zenodo.18614663) (DOI: 10.5281/zenodo.18614663).
