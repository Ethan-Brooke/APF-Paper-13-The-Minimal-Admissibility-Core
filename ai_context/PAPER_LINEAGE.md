# PAPER_LINEAGE.md — Version History for Paper 13

This file tracks the version history of Paper 13 (The Minimal Admissibility Core) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.

---

## Current release

- **Version in this repo:** v8.3-PLEC
- **File in this repo:** `Paper_13_Minimal_Admissibility_Core_v8.3-PLEC.tex` + `.pdf`
- **Page count:** 64 pp
...
- **Concept DOI:** 10.5281/zenodo.18361446
...
- **v8.3-PLEC** (current): see the main paper's changelog section for details.
...
**vv8.3-PLEC supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v8.3-PLEC** (current): see the main paper's changelog section for details.
