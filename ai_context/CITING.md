...
> Brooke, E. S. (2026). *The Minimal Admissibility Core*. Version v8.3-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18614663
...
The DOI `10.5281/zenodo.18614663` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
