...
> Brooke, E. S. (2026). *The Minimal Admissibility Core*. Version v8.3-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18361446

**BibTeX:**

```bibtex
@misc{brooke_paper13_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18361446}
}
```

The DOI `10.5281/zenodo.18361446` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
