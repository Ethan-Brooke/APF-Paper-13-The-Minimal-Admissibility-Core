...
This is the standalone-repo verifier for Minimal Admissibility Core (APF Paper 13).
...
def main():
    ...
    print()
    print("=" * 72)
    print(f"  Paper 13 ({{Minimal Admissibility Core}}): {passed} passed, {failed} failed, "
